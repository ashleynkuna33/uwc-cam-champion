                ...
                <div className="col-span-2">
                    ...
                    <div className="border border-gray-400 rounded-xl p-4 mt-4 bg-white">
                        ...
                        <div className="flex flex-row items-center justify-between">
                            ...
                            <div className="flex border border-gray-500 rounded-md p-1 items-center justify-center">
                    ...
                    <div className="border border-gray-400 rounded-xl p-4 mt-6 bg-white">
                        ...
                        <div className="flex flex-row items-center justify-between">
                            ...
                            <div className="flex items-center border w-16 p-1 rounded-md">
                        ...
                        <div className="flex flex-row mt-6 items-center justify-between">
                            ...
                            <div className="border border-gray-500 bg-gray-500/30 rounded-md flex items-center justify-center p-1">
                ...
                <div className="border border-gray-500 rounded-xl p-4 mt-4 bg-white">
                    ...
                    <div>
                        ...
                        <div className="flex justify-center p-1 pb-2">
                            <div className="border border-gray-500 rounded-md flex items-center justify-center w-[80%] p-1">
